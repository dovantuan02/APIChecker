...
static int open_record_file(int enc_type, int sample_rate, int channel_num, int save_time, int dev_sel)
{
    ...
    case AK_AUDIO_TYPE_AAC:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.aac", save_path, \
        time_str, sample_rate, channel_num, save_time, dev);
        break;
    case AK_AUDIO_TYPE_AMR:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.amr", save_path, \
           time_str, sample_rate, channel_num, save_time, dev);
        break;
    case AK_AUDIO_TYPE_MP3:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.mp3", save_path, \
            time_str, sample_rate, channel_num, save_time, dev);
        break;
    case AK_AUDIO_TYPE_PCM_ALAW:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.g711a", save_path, \
           time_str, sample_rate, channel_num, save_time, dev);
        break;
    case AK_AUDIO_TYPE_PCM_ULAW:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.g711u", save_path, \
           time_str, sample_rate, channel_num, save_time, dev);
        break;
    case AK_AUDIO_TYPE_PCM:
        sprintf(file_path, "%s%s_%d_%d_%d_%s.pcm", save_path, \
          time_str, sample_rate, channel_num, save_time, dev);
        break;
    default:
        sprintf(file_path, "%s%s_%d_%d_%d_%s", save_path, \
          time_str, sample_rate, channel_num, save_time, dev);
        break;
    }
