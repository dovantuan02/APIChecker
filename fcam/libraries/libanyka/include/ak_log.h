 ...
 */
int ak_print(int module_id, int level, \
...
#define ak_print_error_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_ERROR, "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
#define ak_print_warning_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_WARNING, "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
#define ak_print_notice_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_NOTICE, "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
#define ak_print_normal_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_NORMAL, "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
#define ak_print_info_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_INFO, "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
#define ak_print_debug_ex(module_id, fmt, arg...) \
    ak_print(module_id, LOG_LEVEL_DEBUG,  "[%s:%d] "fmt, \
        (char *)__func__, __LINE__, ##arg)
