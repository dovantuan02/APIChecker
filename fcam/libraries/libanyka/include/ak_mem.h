 ...
 */
void * ak_mem_alloc_(int module_id, unsigned int size, \
    const char *func_name, long time);
#define ak_mem_alloc(module_id, size) \
    ak_mem_alloc_(module_id, size, __FUNCTION__, ak_get_os_timestamp())
 ...
 * return: AK_SUCCESS or error_code
 */
int ak_mem_pool_init_(int *p_pool_id, int module_id, unsigned int nmemb, \
    unsigned int size, const char *func_name, long time);
#define ak_mem_pool_init(p_pool_id, module_id, nmemb, size) \
    ak_mem_pool_init_(p_pool_id, module_id, nmemb, size, __FUNCTION__,\
    ak_get_os_timestamp())
 ...
 * return: AK_SUCCESS or error_code
 */
int ak_mem_rb_init_(int *p_rb_id, int module_id, unsigned int size, \
    const char *func_name, long time);
#define ak_mem_rb_init(p_rb_id, module_id, size) \
    ak_mem_rb_init_(p_rb_id, module_id, size, __FUNCTION__, \
    ak_get_os_timestamp())
 ...
 * return: AK_SUCCESS or error_code
 */
int ak_mem_rb_read(int rb_id, int readptr_id, unsigned char *to, \
    int read_len, int *result);
 ...
 */
void * ak_mem_dma_alloc_(int module_id, unsigned int size, \
    const char *func_name, long time);
#define ak_mem_dma_alloc(module_id, size) \
    ak_mem_dma_alloc_(module_id, size, __FUNCTION__, ak_get_os_timestamp())
 ...
 * return AK_SUCCESS if successful, and AK_FAILED if failure.
 */
int ak_mem_dma_pool_create_reserved_obj(enum module_id mid, \
    unsigned long size, unsigned long alloc_threshold);
