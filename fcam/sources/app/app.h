...
enum {
	...
	GW_NET_NETWORK_WIFI_GET_MAC_REQ,
	GW_NET_NETWORK_WIFI_START_AP_MODE_REQ,
	GW_NET_NETWORK_WIFI_STOP_AP_MODE_REQ,
	
	GW_NET_NETWORK_WIFI_CONNECT_REQ,
	GW_NET_NETWORK_WIFI_DISCONN_REQ,

	GW_NET_NETWORK_WIFI_DHCP_REQ,
	GW_NET_NETWORK_WIFI_STATIC_REQ,

	GW_NET_NETWORK_WIFI_SCAN_REQ,
	GW_NET_NETWORK_WIFI_GET_CONN_REQ,


	GW_NET_NETWORK_ETH_GET_MAC_REQ,
	GW_NET_NETWORK_ETH_CONNECT_REQ,
	GW_NET_NETWORK_ETH_DISCONN_REQ,
	GW_NET_NETWORK_ETH_DHCP_REQ,
	GW_NET_NETWORK_ETH_STATIC_REQ,
	GW_NET_NETWORK_ETH_STATE_CAPLE_REQ
};
...
enum {
	/* wifi station interface */
	GW_GPIO_WATCHDOG_PING_REQ = AK_USER_WATCHDOG_SIG,
	GW_GPIO_LIGHTNING_WHITE_REQ		= AK_USER_DEFINE_SIG,
	GW_GPIO_LIGHTNING_IR_REQ,

	GW_GPIO_LED_WHITE_REQ,
	GW_GPIO_LED_YELLOW_REQ,
	GW_GPIO_LED_MAX_REQ,

	GW_GPIO_LED_WHITE_BLINK_REQ,
	GW_GPIO_LED_YELLOW_BLINK_REQ,
	GW_GPIO_LED_MAX_BLINK_REQ,

	GW_GPIO_LED_WHITE_OFF_REQ,
	GW_GPIO_LED_YELLOW_OFF_REQ
};
